          ...
          {results.map((event, index) => (
            <div className="allResults" key={index}>
                ...
                <div>
                  <div className="eventLeft">
                    <div className="eventYearList">
                      <img src="/images/evenement.png"  alt="icône"/>
                    <div className='eventTitle'><h3>L'évènement</h3>
                  <p> {event.evenement}</p> </div>
                    </div>
                    {event.personnage && (
                      <div className="personnage">
                        <div className="personnagePhoto">
                          <img src={event.personnage.photoPersonnage} alt={event.personnage.name} />
                        </div>
                        <div className='personnageTxt'>
                        <h3 className="personnageName">{event.personnage.name}</h3>
                        <div className="personnageDescription">{event.personnage.description}
                        </div>
                        <div className="mediaLinks">
                        <p> Pour les plus curieux !
                                <br/>Découvrez ce personnage d'un autre temps avec nos ressources d'aujourd'hui</p>
              ...
              <div className="eventRight">
                ...
                <img  className="banner" src={event.bannerImage} alt="Bannière thématique" />
              </div>
            </div>
          ))}
        </div>
