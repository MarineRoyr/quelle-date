...
<p>● Propriétaire : Quelle-Date.com - , auteur au capital de €. Le propriétaire du site internet est
joignable à cette adresse : marine.royr@gmail.com</p>
<p>● Créateur du site : Royer</p>
<p>● Responsable publication : Marine ROYER - marine.royr@gmail.com</p>
<p>● Hébergeur : hostinger HOSTINGER operations, UAB</p>
Švitrigailos str. 34, Vilnius 03230 Lithuania
<p>Ces mentions légales sont offertes par Le Générateur de Mentions Légales du Site Français</p></div>
...
décrites. Ces conditions d’utilisation sont susceptibles d’être modifiées ou complétées à tout moment, les
utilisateurs du site sont donc invités à les consulter de manière régulière.
Le site est mis à jour régulièrement par Marine ROYER. De la même façon, les mentions légales peuvent
...
SERVICES FOURNIS
Marine ROYER, s’efforce de fournir sur le site des informations aussi précises que possible.
Toutefois, il ne pourra être tenue responsable des omissions, des inexactitudes et des carences dans la mise
à jour, qu’elles soient de son fait ou du fait des tiers partenaires qui lui fournissent ces informations.
Tous les informations indiquées sur le site quelle-date.com sont données à titre indicatif, et sont
susceptibles d’évoluer. Aussi, toutes les informations indiquées sur le site Site quelle-date.com sont
...
signaler par email, à l’adresse marine.royr@gmail.com, en décrivant le problème de la manière la plus
précise possible (vous vous trouver sur un téléphone, une tablette ou bien un ordinateur ; nom de la page
qui pose problème, type de système d’exploitation, navigateur utilisé,…).
Marine ROYER n’est en aucun cas responsable de l’utilisation faite de ces informations, et de tout préjudice
direct ou indirect pouvant en découler.</div>
<h2>PROPRIETE INTELLECTUELLE ET CONTREFACONS</h2>
<div>
Quelle-Date.com est le propriétaire des droits de propriété intellectuelle ou détient les droits d’usage sur
...
autorisation écrite préalable de : quelle-date.com.
...
pénale du contrefacteur. En outre, les propriétaires des Contenus copiés pourraient intenter une action en
justice à votre encontre.</div>
<h2>LIMITATIONS DE RESPONSABILITES</h2>
<div>
...
Marine ROYER ne pourra être tenue responsable des dommages directs et indirects causés au matériel de
l’utilisateur, lors de l’accès au site quelle-date.com, et résultant soit de l’utilisation d’un matériel ne
répondant pas aux spécifications indiquées ci-dessus, soit de l’apparition d’un bug ou d’une incompatibilité.
Marine ROYER ne pourra également être tenue responsable des dommages indirects (tels par exemple
qu’une perte de marché ou perte d’une chance) consécutifs à l’utilisation du site quelle-date.com.
Des espaces interactifs (possibilité de poser des questions dans l’espace contact) sont à la disposition des
utilisateurs. Marine ROYER se réserve le droit de supprimer, sans mise en demeure préalable, tout contenu
...
Le cas échéant, Marine ROYER se réserve aussi la possibilité de mettre en cause la responsabilité civile
...
1995.
A l’occasion de l’utilisation du site quelle-date.com, peuvent être recueillies : l’URL des liens par
...
En tout état de cause Marine ROYER ne collecte des informations personnelles relatives à l’utilisateur que
pour le besoin de certains services proposés par le site quelle-date.com. L’utilisateur fournit ces
informations en toute connaissance de cause, notamment lorsqu’il procède par lui-même à leur saisie. Il
est alors précisé à l’utilisateur du site quelle-date.com l’obligation ou non de fournir ces informations.
...
Aucune information personnelle de l’utilisateur du site quelle-date.com n’est publiée à l’insu de l’utilisateur,
échangée, transférée, cédée ou vendue sur un support quelconque à des tiers. Seule l’hypothèse du rachat
de Marine ROYER et/ou du site internet de ses droits permettrait la transmission des dites informations à
...
96/9 du 11 mars 1996 relative à la protection juridique des bases de données.</div>
<h2>LIENS HYPERTEXTES ET COOKIES</h2>
<div>
Le site quelle-date.com peut contenir un certain nombre de liens hypertextes vers d’autres sites, mis en
place avec l’autorisation de Marine ROYER.
Cependant, Marine ROYER n’a pas la possibilité de vérifier le contenu des sites ainsi visités, et n’assumera
en conséquence aucune responsabilité de ce fait.
La navigation sur le site quelle-date.com est susceptible de provoquer l’installation de cookie(s) sur
l’ordinateur de l’utilisateur.
Un cookie est un fichier de petite taille, qui ne permet pas l’identification de l’utilisateur, mais qui enregistre
des informations relatives à la navigation d’un ordinateur sur un site. Les données ainsi obtenues visent à
...
présentes sur le réseau Internet ne sauraient engager la responsabilité de Marine ROYER.
Tout contenu téléchargé se fait aux risques et périls de l'utilisateur et sous sa seule responsabilité. En
conséquence, Marine ROYER ne saurait être tenu responsable d'un quelconque dommage subi par
l'ordinateur de l'utilisateur ou d'une quelconque perte de données consécutives au téléchargement.</div>
<h2>DROIT APPLICABLE ET ATTRIBUTION DE JURIDICTION</h2>
Les présentes conditions du site quelle-date.com sont régies par les lois françaises et toute contestation ou
litiges qui pourraient naître de l'interprétation ou de l'exécution de celles-ci seront de la compétence
exclusive des tribunaux dont dépend le siège social de la société Marine ROYER. La langue de référence,
...
<h2>LEXIQUE</h2>
<div>
<p>● Propriétaire du site : Responsable légal des informations contenues dans le site internet</p>
<p>● Responsable publication : Personne en charge de la mise à jour des contenus (textes, visuels,
multimédia, etc.) sur le site internet</p>
<p>● Hébergeur : Espace de stockage du site internet</p>
...
(article 4 de la loi n° 78-17 du 6 janvier 1978).</p></div> 
    </div>
  );
};
